...
export default function AlumniSecuritySettingsPage() {
  ...
  const handleUpdatePassword = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success("Password akun alumni berhasil diperbarui!");
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Pengaturan Keamanan Akun Alumni</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Kelola kata sandi dan proteksi akun jejaring alumni Anda.
        </p>
      </div>
          ...
          <form onSubmit={handleUpdatePassword} className="space-y-4">
            ...
            <div className="pt-2 flex justify-end">
              ...
              >
                ...
                {loading ? "Menyimpan..." : "Perbarui Password Alumni"}
              </Button>
            </div>
          </form>
        </CardContent>
